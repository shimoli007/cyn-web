...
import HeroSection from '../components/sections/case-studies/HeroSection';
...
export default function CaseStudies() {
  ...
  return (
    <Layout title="Case Studies - Cynea">
      <HeroSection />
      
      <section className="py-16 px-6">
        <div className="max-w-6xl mx-auto">
          {/* Filter buttons directly in the page */}
          ...
          {/* Case studies grid directly in the page */}
